...
GGIR(datadir = "C:/myproject",
     outputdir = "C:/myproject/output_myproject/",
...
library(GGIRmatcher) 
match_time_series(
  GGIR_output_dir = "C:/myproject/output/GGIR/output_acc",
  additional_ts_dir = "C:/myproject/output/sensor2/",
  outputdir = "C:/myproject/output/GGIRmatcher",
...
``` r
aggregate_per_window(tspath = "C:/myproject/output/GGIRmatcher/meta/ms5.outraw/",
                     outputdir = "C:/myproject/output/GGIRmatcher/",
                     GGIR_output_dir = "C:/myproject/output/GGIR/output_acc/",
                     qwindow = c(0, 6, 12, 18),
...
``` r
full_window_report(outputdir = "C:/myproject/output/GGIRmatcher/",
                   GGIR_output_dir = "C:/myproject/output/GGIR/output_acc/",
