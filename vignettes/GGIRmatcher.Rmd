...
contain a two-column data frame, including: timestamp and the output of
interest.

Also, it is important that the RData files do only contain this data
frame, with no additional objects. This package includes an example raw
output file from a
